...
namespace HomePage
{
    public partial class OwnerRequestFundStatus : UserControl
    {
        public OwnerRequestFundStatus()
        {
            InitializeComponent();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from RefundReqRejected where RequestFrom='" + Session.sName + "'";
            ...
            string queryy = "select * from RefundReqAccepted where RequestFrom='" + Session.sName + "'";
