...
namespace HomePage
{
    public partial class DecoProfileUpdate : UserControl
    {
        public DecoProfileUpdate()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "select * from D_LOGIN where Name='" + Session.sName + "'";
            ...
            dateTimePicker1.Value = Convert.ToDateTime(dataGridView1.Rows[0].Cells[5].Value.ToString());
            numericUpDown1.Value = Convert.ToDecimal(dataGridView1.Rows[0].Cells[6].Value.ToString());
            textBox6.Text = dataGridView1.Rows[0].Cells[8].Value.ToString();
            richTextBox1.Text = dataGridView1.Rows[0].Cells[9].Value.ToString();
            pictureBox1.Image = GetPhoto((byte[])dataGridView1.Rows[0].Cells[7].Value);
        }
